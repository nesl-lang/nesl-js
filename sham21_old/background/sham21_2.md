...
AVOID escaping whenever possible!  if a string has double quotes in it, it should be assigned using a heredoc instead of escaping the quotes in a quoted inline string

WARN if string has esacped quotes 

WARN if string has escaped newline. or tabs.  

i think its okay if quotes get escaped sometimes.  the real challenge is preserving whitespace and newlines.  thats what this should be really good at.  

ship it.  stop tinkering.  
